...
export const Worker = Effect.gen(function* defineWorker() {
  ...
  return yield* WorkerResource("Worker", {
    ...
    env: {
      ...
      AKAHU_API_BASE_URL: Config.string("AKAHU_API_BASE_URL"),
      ...
      API_RATE_LIMIT_PER_MINUTE: Config.string("API_RATE_LIMIT_PER_MINUTE"),
      DB: database,
      REFRESH_COOLDOWN_SECONDS: Config.string("REFRESH_COOLDOWN_SECONDS"),
      SYNC_LOOKBACK_DAYS: Config.string("SYNC_LOOKBACK_DAYS"),
    },
    main: "./src/index.ts",
    name: isProduction ? "bankglass" : `bankglass-${stage}`,
    observability: {
